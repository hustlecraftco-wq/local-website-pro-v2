...
import { Terminal, Cpu, Globe, Search, Code2, Zap, Brain, Mail, BarChart3, Lock, Sparkles } from "lucide-react";
...
function TiltCard({
  ...
  return (
    ...
    >
      ...
      {/* Card content */}
      <motion.div
        className="relative h-full bg-zinc-900/80 backdrop-blur-xl border border-white/[0.08] rounded-3xl overflow-hidden"
        animate={{
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <TiltCard glowColor="green">
              <div className="p-8 h-full flex flex-col">
                <div className="flex items-center gap-4 mb-6">
                  <AnimatedIcon icon={BarChart3} color="bg-green-500/20 text-green-400" />
                  <h3 className="text-xl font-bold text-white">CRM Built In</h3>
                </div>

                <p className="text-zinc-400 text-sm mb-6 flex-grow">
                  Every lead auto-syncs. No copy/paste. Track every inquiry from first click to closed deal.
                </p>
